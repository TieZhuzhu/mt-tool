 ...
 * <p><b>使用说明：</b></p>
 * <ul>
 *   <li>所有实现类应继承此类，而不是直接实现 MwsPanelProvider 接口</li>
 ...
 * </ul>
 *
 * @see AbstractMwsPanelProvider
 * @author August Lee
 * @since 2025/11/28 10:09
 */
public abstract class AbstractMwsPanelProvider implements MwsPanelProvider {

    /**
     * 受保护的构造函数，防止外部私自创建实例
     * 子类必须通过 init() 方法创建实例
     */
    protected AbstractMwsPanelProvider() {
    }
}
